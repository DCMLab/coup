#!/usr/bin/env python
# coding: utf-8
"""https://github.com/DCMLab/annotation_workflow_template/blob/4535dcaed2449281c7bf19f1d0c34c88e13c2150/.github/workflows/gantt.py"""
import argparse
import os
...
def get_phraseends(
        at: pd.DataFrame,
        column: Literal["quarterbeats", "mn_fraction"] = 'quarterbeats') -> List[float]:
